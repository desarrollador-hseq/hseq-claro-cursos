...
const KIT_RESCATE_TYPES = [
  { value: "ARNES_RESCATE", name: "ARNÉS" },
  { value: "POLIPASTO_RESCATE", name: "POLIPASTO" },
  { value: "MOSQUETON_RESCATE", name: "MOSQUETÓN" },
  { value: "ANCLAJE_PORTATIL_RESCATE", name: "ANCLAJE PORTÁTIL" },
  { value: "BLOQUEADORES_RESCATE", name: "BLOQUEADOR" },
];
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    >
                      ...
                      <SelectContent>
                        {inspection.isKitRescue && KIT_RESCATE_TYPES.map((type) => (
                          <SelectItem key={type.value} value={type.value}>
                            {type.name}
                          </SelectItem>
                        ))}
                        {!inspection.isKitRescue && EPP_TYPES.map((type) => (
                          <SelectItem key={type.value} value={type.value}>
                            {type.name}
                          </SelectItem>
                        ))}
